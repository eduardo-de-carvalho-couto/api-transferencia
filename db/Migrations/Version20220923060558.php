 ...
 */
final class Version20220923060558 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE lojas (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nome VARCHAR(45) NOT NULL, email EMAIL NOT NULL, senha VARCHAR(19) DEFAULT NULL, cnpj VARCHAR(19) NOT NULL)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__lojas AS SELECT id, nome, email, senha, cnpj FROM lojas');
        $this->addSql('DROP TABLE lojas');
        $this->addSql('CREATE TABLE lojas (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nome VARCHAR(45) NOT NULL, email EMAIL DEFAULT NULL, senha VARCHAR(19) DEFAULT NULL, cnpj VARCHAR(19) NOT NULL)');
        $this->addSql('INSERT INTO lojas (id, nome, email, senha, cnpj) SELECT id, nome, email, senha, cnpj FROM __temp__lojas');
        $this->addSql('DROP TABLE __temp__lojas');
        $this->addSql('CREATE TEMPORARY TABLE __temp__pessoas AS SELECT id, nome, email, senha, cpf FROM pessoas');
        $this->addSql('DROP TABLE pessoas');
        $this->addSql('CREATE TABLE pessoas (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nome VARCHAR(45) NOT NULL, email EMAIL DEFAULT NULL, senha VARCHAR(19) DEFAULT NULL, cpf VARCHAR(15) NOT NULL)');
        $this->addSql('INSERT INTO pessoas (id, nome, email, senha, cpf) SELECT id, nome, email, senha, cpf FROM __temp__pessoas');
        $this->addSql('DROP TABLE __temp__pessoas');
    }
}
